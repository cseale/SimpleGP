...
sgp = SimpleGP(tournament_size = tour_size,
fitness_function, backprop_function, functions, terminals, pop_size = 250, max_time = 30, backprop_selection_ratio = 1, backprop_every_generations = 1)	# other parameters are optional
